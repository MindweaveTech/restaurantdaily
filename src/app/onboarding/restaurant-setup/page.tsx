...
import { ChefHat, Building2, ExternalLink, ArrowRight, ArrowLeft, CheckCircle, AlertTriangle, MapPin, Phone, Mail, Info } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-6 sm:py-8 max-w-xl flex-1 flex flex-col">
        ...
        <GlassCard size="lg" variant="orange" className="flex-1 flex flex-col">
          ...
          <div className="flex justify-between items-center mt-8 pt-6 border-t border-white/10">
            ...
            >
              {loading ? 'Creating...' : step === 3 ? 'Complete Setup' : 'Next'}
            </GlassButton>
          </div>
        </GlassCard>
      </div>
